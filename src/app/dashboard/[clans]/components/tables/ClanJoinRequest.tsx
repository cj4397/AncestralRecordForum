...
import AcceptJoinRequest from '../modals/AcceptJoinRequest'

export default function ClanJoinRequest(props: any) {
    const { request, clan_name } = props

    const clan_list = request
    ...
    return (
        <div>
            <table className='table is-striped is-hoverable is-fullwidth'>
                <thead>
                    <tr>
                        <th className='has-text-centered'>Requester's Name</th>
                        <th className='has-text-centered'>Reason</th>
                        <th className='has-text-centered'>Requested At</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    {show.map((e: any) => (
                        ...
                        >
                            ...
                            <td className='has-text-centered'>{e.details}</td>
            ...
            {modal_open && <AcceptJoinRequest setModal={setModal} modal_open={modal_open} clan_name={clan_name} request={clan} />}
        </div>
    )
}
