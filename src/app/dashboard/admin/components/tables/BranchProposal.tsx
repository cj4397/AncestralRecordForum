...
import BranchApproval from '../modals/BranchApproval'

export default function BranchProposal(props: any) {
    const { branch } = props

    const clan_list = branch
    ...
    return (
        <div>
            <table className='table is-striped is-hoverable is-fullwidth'>
                <thead>
                    <tr>
                        <th className='has-text-centered'>Main Clan Name</th>
                        <th className='has-text-centered'>Branch Clan Name</th>
                ...
                <tbody>
                    {show.map((e: any) => (
                        <tr key={e.id}
                            onClick={() => buy(e)}
                        >
                            <td className='has-text-centered'>{e.request.main_clan}</td>
            ...
            {modal_open && <BranchApproval setModal={setModal} modal_open={modal_open} clan={clan} />}
        </div>
    )
}
